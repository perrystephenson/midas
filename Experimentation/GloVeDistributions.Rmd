...
start by looking at the biggest outliers overall.
...
These are definitely bad sentences! Let's see if I can find the worst sentences 
(globally) from the "draft document" under assessment (i.e. Case Study ID 11764)
